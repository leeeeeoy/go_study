...
func (clu *CommentLikeUpdate) ClearUserID() *CommentLikeUpdate {
...
func (clu *CommentLikeUpdate) ClearCommentID() *CommentLikeUpdate {
	clu.mutation.ClearCommentID()
	return clu
}
...
// ClearUserID clears the value of the "user_id" field.
func (cluo *CommentLikeUpdateOne) ClearUserID() *CommentLikeUpdateOne {
...
// ClearCommentID clears the value of the "comment_id" field.
func (cluo *CommentLikeUpdateOne) ClearCommentID() *CommentLikeUpdateOne {
	cluo.mutation.ClearCommentID()
	return cluo
}
