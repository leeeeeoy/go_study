...
func (tu *TopicUpdate) SetCategoryID(i int) *TopicUpdate {
	tu.mutation.SetCategoryID(i)
	return tu
}

// SetNillableCategoryID sets the "category_id" field if the given value is not nil.
func (tu *TopicUpdate) SetNillableCategoryID(i *int) *TopicUpdate {
	if i != nil {
		tu.SetCategoryID(*i)
	}
	return tu
...
func (tu *TopicUpdate) ClearCategoryID() *TopicUpdate {
...
func (tu *TopicUpdate) AddBoardIDs(ids ...int) *TopicUpdate {
	tu.mutation.AddBoardIDs(ids...)
	return tu
}

// AddBoards adds the "boards" edges to the Board entity.
func (tu *TopicUpdate) AddBoards(b ...*Board) *TopicUpdate {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
	return tu.AddBoardIDs(ids...)
}

// SetCategory sets the "category" edge to the Category entity.
func (tu *TopicUpdate) SetCategory(c *Category) *TopicUpdate {
...
func (tu *TopicUpdate) ClearBoards() *TopicUpdate {
	tu.mutation.ClearBoards()
	return tu
}

// RemoveBoardIDs removes the "boards" edge to Board entities by IDs.
func (tu *TopicUpdate) RemoveBoardIDs(ids ...int) *TopicUpdate {
	tu.mutation.RemoveBoardIDs(ids...)
	return tu
}

// RemoveBoards removes "boards" edges to Board entities.
func (tu *TopicUpdate) RemoveBoards(b ...*Board) *TopicUpdate {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
	return tu.RemoveBoardIDs(ids...)
}

// ClearCategory clears the "category" edge to the Category entity.
func (tu *TopicUpdate) ClearCategory() *TopicUpdate {
...
func (tu *TopicUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := tu.mutation.RemovedBoardsIDs(); len(nodes) > 0 && !tu.mutation.BoardsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   topic.BoardsTable,
	...
	if nodes := tu.mutation.BoardsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   topic.BoardsTable,
...
// SetCategoryID sets the "category_id" field.
func (tuo *TopicUpdateOne) SetCategoryID(i int) *TopicUpdateOne {
	tuo.mutation.SetCategoryID(i)
	return tuo
}

// SetNillableCategoryID sets the "category_id" field if the given value is not nil.
func (tuo *TopicUpdateOne) SetNillableCategoryID(i *int) *TopicUpdateOne {
	if i != nil {
		tuo.SetCategoryID(*i)
	}
	return tuo
...
// ClearCategoryID clears the value of the "category_id" field.
func (tuo *TopicUpdateOne) ClearCategoryID() *TopicUpdateOne {
...
// AddBoardIDs adds the "boards" edge to the Board entity by IDs.
func (tuo *TopicUpdateOne) AddBoardIDs(ids ...int) *TopicUpdateOne {
	tuo.mutation.AddBoardIDs(ids...)
	return tuo
}

// AddBoards adds the "boards" edges to the Board entity.
func (tuo *TopicUpdateOne) AddBoards(b ...*Board) *TopicUpdateOne {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
	return tuo.AddBoardIDs(ids...)
}

// SetCategory sets the "category" edge to the Category entity.
func (tuo *TopicUpdateOne) SetCategory(c *Category) *TopicUpdateOne {
...
// ClearBoards clears all "boards" edges to the Board entity.
func (tuo *TopicUpdateOne) ClearBoards() *TopicUpdateOne {
	tuo.mutation.ClearBoards()
	return tuo
}

// RemoveBoardIDs removes the "boards" edge to Board entities by IDs.
func (tuo *TopicUpdateOne) RemoveBoardIDs(ids ...int) *TopicUpdateOne {
	tuo.mutation.RemoveBoardIDs(ids...)
	return tuo
}

// RemoveBoards removes "boards" edges to Board entities.
func (tuo *TopicUpdateOne) RemoveBoards(b ...*Board) *TopicUpdateOne {
	ids := make([]int, len(b))
	for i := range b {
		ids[i] = b[i].ID
	}
	return tuo.RemoveBoardIDs(ids...)
}

// ClearCategory clears the "category" edge to the Category entity.
func (tuo *TopicUpdateOne) ClearCategory() *TopicUpdateOne {
...
func (tuo *TopicUpdateOne) sqlSave(ctx context.Context) (_node *Topic, err error) {
	...
	if nodes := tuo.mutation.RemovedBoardsIDs(); len(nodes) > 0 && !tuo.mutation.BoardsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   topic.BoardsTable,
	...
	if nodes := tuo.mutation.BoardsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   topic.BoardsTable,
